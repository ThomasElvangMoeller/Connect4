...
import { User, UserManager, WebStorageStateStore } from "oidc-client"; //TODO, change from oidc to bearer https://jasonwatmore.com/post/2020/04/19/angular-9-jwt-authentication-example-tutorial
